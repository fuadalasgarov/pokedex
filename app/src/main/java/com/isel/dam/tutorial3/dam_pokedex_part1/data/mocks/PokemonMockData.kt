package com.isel.dam.tutorial3.dam_pokedex_part1.data.mocks

import com.isel.dam.tutorial3.dam_pokedex_part1.R
import com.isel.dam.tutorial3.dam_pokedex_part1.data.*
...
object PokemonMockData {
    ...
    var pokemons = listOf(
        Pokemon(1,
            ...
            regions[1], listOf(pokemonTypeMock[1], pokemonTypeMock[10])
        ),
        Pokemon(4,
            "charmander",
            "https://raw.githubusercontent.com/PokeAPI/sprites/master" +
